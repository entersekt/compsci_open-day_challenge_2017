The Entersekt 2017 Computer Science Coding Challenge
---
...
2. Refer to [What is Docker?](https://www.docker.com/what-docker) and the [Dockerfile Reference](https://docs.docker.com/engine/reference/builder/). Create a Dockerfile that will allow one to use the .docker build. command on a Linux or Mac OS X machine to create a container distribution of your program. 

# Submission Guidelines
* We recommend making use of the openjdk base image at [https://hub.docker.com/_/openjdk/](https://hub.docker.com/_/openjdk/) to derive your Dockerfile from.
* Add a README.md file with the necessary steps on how to compile your program, build the container, run it and then consume your REST service.
